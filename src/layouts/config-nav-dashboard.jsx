...
export const navData = [
   ...
   */
  {
    ...
    items: [
      ...
      {
        title: 'Banners', path: paths.dashboard.banners.list, icon: ICONS.label,
        children: [
          { title: 'App Banners', path: paths.dashboard.banners.list },
          { title: 'Dashboard Banners', path: paths.dashboard.banners.dashlist },
        ],
      },
