...
export const MEAL_VARIANT_OPTIONS = [
  { label: 'Upgraded Meal', value: 'upgrade' },
  { label: 'Daily Meal', value: 'daily' },
  { label: 'Live Counter', value: 'live' },
];

export const PRODUCT_CATEGORY_OPTIONS = ['Homely', 'Healthy', 'Low Carbs'];
...
export const PRODUCT_CATEGORY_GROUP_OPTIONS = [
  ...
  { group: 'Veg', classify: ['Veg Thali',] },
  { group: 'Non Veg', classify: ['Chicken Salad'] },
];
