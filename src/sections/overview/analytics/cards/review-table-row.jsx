...
export function ReviewTableRow({ row, selected, onEditRow, onSelectRow, onDeleteRow }) {
  ...
  return (
    <>
      <TableRow hover selected={selected} aria-checked={selected} tabIndex={-1} >
        ...
        <TableCell sx={{ whiteSpace: 'nowrap' }}>{row.mealItem}</TableCell>

        <TableCell sx={{ whiteSpace: 'nowrap' }}>{row.ratings}</TableCell>
