  ...
  return (
    <DashboardContent maxWidth="xl">
      <Grid container spacing={3}>
        ...
        <Grid xs={12} md={4}>
          <div style={{backgroundImage: `url('/src/assets/sunny.jpg')`,backgroundSize: 'cover', backgroundRepeat: 'no-repeat', backgroundPosition: 'center', width: '90%', height: '20vh', borderRadius: '1rem', display: 'flex', flexDirection: 'row'}}>
