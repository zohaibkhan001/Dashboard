  ...
  return (
    <DashboardContent maxWidth="xl">
      <Grid container spacing={3}>
        ...
        <Grid xs={12} md={4}>
          <AppWidgetSummary title="Total active users" total={18765} chart={{}} />
        </Grid>
        ...
        <Grid xs={12} md={4}>
          <AppWidgetSummary title="Total Food Items" total={18765} chart={{}} />
        </Grid>
          ...
          <AppAreaInstalled
            ...
            chart={{
              ...
              series: [
                {
                  name: '2022',
                  data: [{ name: '', data: [12, 10, 18, 22, 20, 12, 8, 21, 20, 14, 15, 16] }],
                },
                {
                  name: '2023',
                  data: [{ name: '', data: [6, 18, 14, 9, 20, 6, 22, 19, 8, 22, 8, 17] }],
                },
                {
                  name: '2024',
                  data: [{ name: '', data: [6, 20, 15, 18, 7, 24, 6, 10, 12, 17, 18, 10] }],
                },
              ],
            }}
          />
